...
class JWTClient:
    ...
    def __post_init__(self):
        if self.cred_path.exists(): 
            ...
            if data is None:
                ...
                """
                `creds.json` was not tampered with Verify token 
    ...
    def perform_auth(self):
        ...
        password(s) during the collection process.
        """
    ...
    def write_creds(self, data:dict):
        ...
        and update instance with correct data.
        """
    ...
    def clear_tokens(self):
        """
        Remove any/all JWT token data from instance
        as well as stored creds file.
        """
        self.access = None
        self.refresh = None
        if self.cred_path.exists():
